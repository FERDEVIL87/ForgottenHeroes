...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                      Maveric Overdrive Edition

                       made by Matt and YinYin
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
1. Installation
2. Moves
...
----------------------------------------------------------------------
 ...
 Execute the install.exe, choose the directory of an original,
 unmodified Little Fighter 2 and click install.

 The installation includes two different face pictures, the default
 one is more lf2-like. If you prefer the other one (maveric_fb.bmp)
 you can simply change the file names to use it.
...
----------------------------------------------------------------------
 ...
 Simply rename the included data_backup.txt into data.txt and copy it
 to the data folder, overwriting the installed one. If you also want
 to get rid of the character data, it is located inside the folder
 sprites\maveric\.
...
----------------------------------------------------------------------
 ...
 Matt
   concept, character sprites, face pictures, artwork
 YinYin
   concept, character data, sounds, effects
